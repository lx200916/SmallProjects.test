...
dojo.version={major:0,minor:4,patch:1,flag:"-20070622",revision:Number("$Rev: 6824 $".match(/[0-9]+/)[0]),toString:function(){
with(dojo.version){
...
var _495;
var _496=doc.getElementsByTagName("style");
if(_496.length==0){
_495=doc.createElement("style");
...
if(_495.styleSheet){
_495.styleSheet.cssText+="\n"+_492;
}else{
var _498=doc.createTextNode("\n"+_492);
